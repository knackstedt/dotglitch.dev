...
const makeLiteral = function (text) {
...
const get_flag_name = function (flag) {
    var flag_names;
    flag_names = {
        A: 'pcre:anchored',
...
const rx2rr = function (node, options) {
...
const quantifiedComment = function (comment, lazy, possessive, attrs) {
...
const parseRegex = function (regex) {
